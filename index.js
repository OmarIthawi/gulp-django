...
var optimize_js = function(opts){
    var root = opts.root || './';
    var output = opts.output || DEFAULT_ROOT_BUILD_DIR;

    var static_folders = getStaticFolders(root);
    ...
    var tasks = static_folders.map(function(static_folder) {
        ...
        var output_dir = {
            plain: output + PLAIN_BUILD_DIR + app_name + '/js/',
            optimized: output + OPTIMIZED_BUILD_DIR + app_name + '/js/'
        };
...
var optimize_images = function(opts){
    var root = opts.root || './';
    var output = opts.output || DEFAULT_ROOT_BUILD_DIR;
    ...
    var tasks = static_folders.map(function(static_folder) {
        ...
        var output_dir = {
            optimized: output + OPTIMIZED_BUILD_DIR + app_name + '/img/'
        };
